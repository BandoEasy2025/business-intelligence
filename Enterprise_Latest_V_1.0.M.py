...
def save_to_csv(businesses: List[Dict[Any, Any]], output_file: str):
    """
    ...
    # fieldnames = [
    #     'Business Name', 'Category', 'Address', 'City',
    #     'Phone Number', 'Email', 'Website', 'Google Rating',
    #     'Number of Reviews', 'API Source'
    # ]
    ...
    try:
        ...
        logger.info(f"Successfully saved {len(businesses)} businesses to {output_file}")
    except Exception as e:
...
def main():
    ...
    if interactive_mode:
        ...
        parser.add_argument('--category', required=True, choices=['hotel', 'restaurant', 'bar', 'cafe', 'bakery', 'nightclub', 'all'],
